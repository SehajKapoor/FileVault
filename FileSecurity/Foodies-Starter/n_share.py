...
def generate_shares(data, share = 2):
    ...
    for i in range(data.shape[0]):
        for j in range(data.shape[1]):
            for k in range(data.shape[2]):
                n = int(np.random.randint(data[i, j, k] + 3))
                img1[i, j, k] = n
    ...
    img1.save("static/encryption/visualcry/images/pic1.png", "PNG")
    img2.save("static/encryption/visualcry/images/pic2.png", "PNG")

def compress_shares(img1="static/decryption/shares/share1.png", img2="static/decryption/shares/share2.png"):
    # Read images
    ...
    img.save("static/decryption/shares/compress.png", "PNG")
